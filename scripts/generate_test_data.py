...
DENSE_CLUSTERS = {
    ...
    "values": [
        {"topic": "称賛文化", "templates": [
            ...
            "他チームの成功事例をもっと共有し、祝うべきです。", "日々の小さな貢献にもスポットライトを当てるべきです。",
        ...
        {"topic": "顧客志向", "templates": [
            ...
            "ペルソナに基づいた開発ができていません。", "真の顧客価値とは何かを常に問い続けたいです。",
