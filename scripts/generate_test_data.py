...
DENSE_CLUSTERS = {
    ...
    "values": [
        ...
        {"topic": "顧客志向", "templates": [
            "ユーザーの声を直接聞く機会をもっと増やすべきです。", "ドッグフーディングを徹底して自分たちで製品を使うべきです。", 
            "売上よりもユーザー満足度をKPIにすべきです。", "カスタマーサポートからのフィードバックを開発に活かしましょう。",
            "ペルソナ設定が古くなっています。"
        ]},
        {"topic": "スピード", "templates": [
            "意思決定のスピードを上げて、競合に先んじましょう。", "完璧を目指すより、まずはリリースして反応を見たいです。", 
            "承認プロセスが長すぎてチャンスを逃しています。", "アジャイルな開発プロセスを徹底しましょう。"
        ]}
    ]
}
