...
DENSE_CLUSTERS = {
    ...
    "values": [
        {"topic": "称賛文化", "templates": [
            "もっと互いに称賛し合う文化を作るべきです。", "感謝を伝える仕組み（Thanksカードなど）が形骸化しています。", 
            "成果だけでなくプロセスも評価してほしいです。", "ネガティブな指摘ばかりでなく、ポジティブなフィードバックが欲しいです。",
            "他チームの成功事例をもっと共有し、祝うべきです。"
        ]},
        {"topic": "挑戦", "templates": [
            "新しい技術への挑戦が推奨されていません。", "失敗を恐れずにチャレンジできる環境が必要です。", 
            "守りに入りすぎていて、成長が感じられません。", "イノベーションを起こすための時間が確保できません。",
            "新しいツールの導入ハードルが高すぎて、挑戦意欲が削がれます。"
        ]},
        {"topic": "心理的安全性", "templates": [
            "ミスを責める文化があり、萎縮しています。", "反対意見を言える雰囲気がありません。",
            "若手が自由に発言できる環境ではありません。"
        ]},
        {"topic": "顧客志向", "templates": [
            "ユーザーの声を直接聞く機会が不足しています。", "ドッグフーディングをもっと徹底すべきです。", 
            "売上優先で、ユーザー満足度が二の次になっています。", "カスタマーサポートからのフィードバックが開発に活かされていません。",
            "ペルソナに基づいた開発ができていません。"
        ]},
        {"topic": "スピード", "templates": [
            "意思決定のスピードが遅く、競合に負けています。", "完璧を目指しすぎて、リリースが遅れています。", 
            "承認プロセスが複雑で、スピード感を殺しています。", "もっとアジャイルに動くべきです。"
        ]}
    ]
}
    ...
    if category == 'project':
        ...
        topics = [
            ...
            lambda: generate_sentence([
                ...
                ["だと思います。", "といいですね。", "文化を作りましょう。", "とモチベーションが上がります。"]
            ]),
            # 挑戦
            lambda: generate_sentence([
            ...
            lambda: generate_sentence([
                ...
                ["組織には不可欠です。", "あるべき姿です。", "生産性を高めます。", "欠けていると感じます。"]
            ]),
            # 顧客志向
            lambda: generate_sentence([
                ["ユーザー視点を", "顧客の声を", "現場の意見を"], 
                ["もっと大事に", "開発に反映", "優先"], 
                ["するべきです", "したいです", "しないと勝てません"], 
                ["。", "と思います。"]
            ]),
            # スピード
            lambda: generate_sentence([
                ["意思決定を", "開発スピードを", "リリースサイクルを"], 
                ["もっと速く", "迅速に", "アジャイルに"], 
                ["するべきです", "回すべきです", "しないと遅れます"], 
                ["。", "と感じます。"]
            ])
        ]
